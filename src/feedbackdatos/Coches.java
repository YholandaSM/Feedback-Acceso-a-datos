...
public class Coches  implements java.io.Serializable {
    ...
    public Coches(byte idCoche, String matricula, Date fechaMatriculacion) {
        this.idCoche = idCoche;
        this.matricula = matricula;
        this.fechaMatriculacion = fechaMatriculacion;
    }
    public Coches(byte idCoche, String matricula, Float precio, String color, String marca, Date fechaMatriculacion) {
       this.idCoche = idCoche;
       this.matricula = matricula;
       this.precio = precio;
       this.color = color;
